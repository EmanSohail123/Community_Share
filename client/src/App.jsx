...
function Landing() {
  ...
  return (
    <main className="landing page-shell">
      <nav className="topbar"><Brand /><div className="nav-links"><a href="#how-it-works">How it works</a>{token ? <Link className="button button-dark" to="/dashboard">Open dashboard</Link> : <Link className="button button-dark" to="/login">Log in <span aria-hidden="true">↗</span></Link>}</div></nav>
